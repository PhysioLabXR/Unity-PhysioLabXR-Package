...
namespace Unity_PhysioLabXR_Plugin.Samples.GRPC
{
    public class ExampleClient : MonoBehaviour
    {
        ...
        private RPCTest.RPCTestClient client;
        ...
        public void OnCallRPC()
        {
            ...
            var reply = client.TestRPCOneArgOneReturn(new TestRPCOneArgOneReturnRequest { Input0 = "Unity" });
